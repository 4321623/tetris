...
#            f = A[x+8]
            ...
            HAI=self.HAI_type(self.CurrentShape_index,x)
            print("===HAI===")
            pprint.pprint(HAI)
...
#                ]
            ...
            print("jyouken=")
            print("A: ","A[xx-3]","A[xx-2]","A[xx-1]","A[xx]","A[xx+1]=","A[xx+2]")
            print("H[jyouken][n]: ","[0]","[1]","[2]", "ho" ,"[4]","[5]")

          
            for jyouken in range (0,JyoukenNoMAX):
                xx = x + 3
                print("jyouken=",jyouken)
                print("A:", A[xx-3],A[xx-2],A[xx-1],A[xx],A[xx+1],A[xx+2])
                print("H: ", HAI[jyouken][0],HAI[jyouken][1],HAI[jyouken][2],"ho",HAI[jyouken][4],HAI[jyouken][5])
                    
                if A[xx] - A[xx-3] == HAI[jyouken][0]: #A(x)-A(x-3)
                    print("(x-3)○","A[xx] - A[xx-3] == HAI[jyouken][0]")
                 
                    if A[xx] - A[xx-2] == HAI[jyouken][1]: #A(x)-A(x-2)
                        print("(x-2)○","A[xx] - A[xx-2] == HAI[jyouken][1]")
                        
                        if A[xx] - A[xx-1] == HAI[jyouken][2]: #A(x)-A(x-1)
                            print("(x-1)○","A[xx] - A[xx-1] == HAI[jyouken][2]")
                            
                            if A[xx] - A[xx+1] == HAI[jyouken][4]: #A(x)-A(x+1)
                                print("(x+1)○","A[xx] - A[xx+1] == HAI[jyouken][4]")

                                if A[xx] - A[xx+2] == HAI[jyouken][5]: #A(x)-A(x+2)
                                    print("(x+2)○","A[xx] - A[xx+2] == HAI[jyouken][5]")
